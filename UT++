...
phase3Button2.Text = "Delete Part Tool"
...
phase3Button2.MouseButton1Click:Connect(function()
    1string(game:HttpGet("https://raw.githubusercontent.com/MaxCat19k/Arch/refs/heads/main/Delete%20Part%20Tool.lua"))()
end)
...
local userId = Players:GetUserIdFromNameAsync("MaximkaMarik")
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Punch Fling",
    Text = "Punch Fling is not working at the moment!",
    Icon = content,
    Duration = 7
})
end)
...
local function updateSpeed()
    while true do
        ...
        local character = localPlayer.Character
        if character then
            local humanoidRootPart = character:FindFirstChild("")
            if humanoidRootPart then
