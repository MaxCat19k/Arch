...
phase3Button2.Text = "Delete Parts Tool"
...
phase3Button6.Text = "doesn't work"
...
phase3Button2.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/MaxCat19k/Arch/refs/heads/main/Delete%20Part%20Tool.lua"))()
end)
